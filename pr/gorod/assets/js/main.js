...
$(function(){
  ...
  $(document).ready(function(){
    if ($(window).width() > 1199) {
      $('meta[name="viewport"]').attr('content', 'width=1172');
...
//     var animtime  = 500; // [px]    400
//     var stepsize  = 103.5; // [px]    120
...
// })(jQuery);
$('#btn-modal').fancybox();
$('.nav-list__link--modal').fancybox();
var
$headerHeight = $('.header-toggle').outerHeight(),
$hBillboard = $('.billboard').outerHeight(),
$scrolled,
$scrolledLeft;

function billboardIndent(){
	$('.billboard').css('top', 0);
...
function parallaxScroll(){
	...
	if($(window).scrollTop() < 725){
		$('.header-toggle').css('top',(- ($scrolled*.5))+'px');
		$('.billboard').css('top',( - ($scrolled*.25))+'px');
		$('.billboard-block').css('top',( - ($scrolled*.75))+'px');
	}
}
...
function blockScroll(){
	$('.header-toggle').css('margin-left',-$scrolledLeft+'px');
	$('.billboard').css('margin-left',-$scrolledLeft+'px');
}

function blockWidth(){
	$('.header-toggle').css('width', $(document).width());
	$('.billboard').css('width', $(document).width());
}
blockWidth()
...
$('.how-block').mouseenter(function(){
	var elem = $(this).find('.how-block__logo'),
	logoHover = $(elem).attr('data-logo-hover');
...
blockHeight('.shares-block__title');
blockHeight('.shares-block__desc');
blockHeight('.shares-block--height');
...
$('.sorting-select__title').on('click', function(){
	var $this = $(this),
			$sortNav = $this.next('.sorting-select__hidden');

	$this.toggleClass('sorting-select__title--active');
	$sortNav.fadeToggle(200);
})
});
